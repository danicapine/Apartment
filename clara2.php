...
<html lang="en">
  ...
  <?php include('mainheader.php'); ?>
    ...
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url('images/clara.jpg');"
    data-aos="fade" data-stellar-background-ratio="0.5" data-aos="fade">
    <div class="container">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade-up" data-aos-delay="400">
          <h1 class="text-white">Clara</h1>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
      <div class="featured-property-half d-flex">
        <div class="image" style="background-image: url('images/cl8.jpg')"></div>
        <div class="text">
        <h2>Property Information</h2>
            ...
            <ul class="property-list-details mb-5">
                <li class="text-black">Property Name: <strong class="text-black">Clara</strong></li>
      ...
      <div class="container">
        <div class="row">
          <div class="site-section-heading text-center mb-5 w-border col-md-6 mx-auto">
            <h2 class="mb-5">Presenting Clara</h2>
            <p>You look like Clara bow in this light remarkable.</p>
          </div>
        </div>
        <div class="row">

          <div class="col-md-6 col-lg-3 mb-5" data-aos="fade-up" data-aos-delay="100">
            <a href="clara.php" class="unit-9">
              <div class="image" style="background-image: url('images/clr1.jpg');"></div>
          ...
          <div class="col-md-6 col-lg-3 mb-5" data-aos="fade-up" data-aos-delay="200">
            <a href="clara.php" class="unit-9">
              <div class="image" style="background-image: url('images/clr2.jpg');"></div>
              <div class="unit-9-content">
              </div>
            </a>
          </div>
          ...
          <div class="col-md-6 col-lg-3 mb-5" data-aos="fade-up" data-aos-delay="400">
            <a href="clara.php" class="unit-9">
              <div class="image" style="background-image: url('images/clr4.jpg');"></div>
              <div class="unit-9-content">
              </div>
            </a>
          </div>
          ...
          <div class="col-md-6 col-lg-3 mb-5" data-aos="fade-up" data-aos-delay="100">
            <a href="clara.php" class="unit-9">
              <div class="image" style="background-image: url('images/clr5.jpg');"></div>
              <div class="unit-9-content">
              </div>
            </a>
          </div>
          ...
          <div class="col-md-6 col-lg-3 mb-5" data-aos="fade-up" data-aos-delay="200">
            <a href="clara.php" class="unit-9">
              <div class="image" style="background-image: url('images/clr8.jpg');"></div>
              <div class="unit-9-content">
              </div>
            </a>
          </div>
          <div class="col-md-6 col-lg-3 mb-5" data-aos="fade-up" data-aos-delay="300">
            <a href="clara.php" class="unit-9">
              <div class="image" style="background-image: url('images/clr6.jpg');"></div>
              <div class="unit-9-content">
              </div>
            </a>
          </div>
          <div class="col-md-6 col-lg-3 mb-5" data-aos="fade-up" data-aos-delay="400">
            <a href="clara.php" class="unit-9">
              <div class="image" style="background-image: url('images/clr7.jpg');"></div>
              <div class="unit-9-content">
              </div>
            </a>
          </div>
