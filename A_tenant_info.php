                                ...
                                <?php foreach ($tenants as $tenant): ?>
                                    <tr>
                                        ...
                                        <td class="action-btns">
                                            <a href="A_tenants_view.php?id=<?php echo $tenant['id'];  ?>"  class="btn btn-info btn-sm mr-2" style="border-radius: 18px">
                                                <i class="fas fa-eye"></i> <!-- Font Awesome icon for view -->
                                            </a>
                                            <a href="A_tenant_update.php?id=<?php echo $tenant['id']; ?>" class="btn btn-primary btn-sm mr-2" style="background-color: #FFAE42; border-color:#FFAE42; border-radius: 18px">
                                                <i class="fas fa-edit"></i> <!-- Font Awesome icon for edit -->
                                            </a>
                                            <a href="A_tenants_delete.php?id=<?php echo $tenant['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this tenant?')" style="border-radius: 18px">
