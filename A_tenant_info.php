...
<head>
    ...
    <title>Tenant's Informations</title>
    <style>
        h3 {
        text-align: center;
        margin-bottom: 20px;
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h3 class="fs-4 m-0" id="hhh">Tenant's Information</h3>
                </div>
                ...
                <h3 class="text-center mb-3 animated-heading">List of Tenants</h3>
                    <div class="header">
                        ...
                        <div class="search-bar">
                            <form method="GET" action="tenant_info.php">
                                ...
                                <?php foreach ($tenants as $tenant): ?>
                                    <tr>
                                        ...
                                        <td class="action-btns">
                                            <a href="tenants_view.php?id=<?php echo $tenant['id'];  ?>"  class="btn btn-info btn-sm mr-2" style="border-radius: 18px">
                                                <i class="fas fa-eye"></i> <!-- Font Awesome icon for view -->
                                            </a>
                                            <a href="tenant_update.php?id=<?php echo $tenant['id']; ?>" class="btn btn-primary btn-sm mr-2" style="background-color: #FFAE42; border-color:#FFAE42; border-radius: 18px">
                                                <i class="fas fa-edit"></i> <!-- Font Awesome icon for edit -->
                                            </a>
                                            <a href="tenants_delete.php?id=<?php echo $tenant['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this tenant?')" style="border-radius: 18px">
