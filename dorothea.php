        ...
        <div class="container py-1">
          <div class="row align-items-center">
            <div class="col-8 col-md-8 col-lg-4">
              <h1 class="mb-0"><a href="index.html" class="text-white h2 mb-0"><strong>TTPD HOMES<span class="text-primary">.</span></strong></a></h1>
            </div>
                ...
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  ...
                  <li class="has-children active">
                    ...
                    <ul class="dropdown arrow-top">
                      <li><a href="room.php">Apartments</a></li>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade-up" data-aos-delay="400">
          <h1 class="text-white">Dorothea Apartment</h1>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="container">
        <div class="row">
          <div class="site-section-heading text-center mb-5 w-border col-md-6 mx-auto">
            <h2 class="mb-5">Dorothea Rooms</h2>
