    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade-up" data-aos-delay="400">
          ...
          <p>Elevate your lifestyle at TTPD Homes.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container" data-aos="fade-up">
      <div class="row">
        <div class="site-section-heading text-center mb-5 w-border col-md-6 mx-auto">
          ...
          <p>Discover the expert teams dedicated to curating modern living spaces tailored to your needs with passion and expertise.</p>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
          <div class="team-member">
            ...
            <img src="images/ezeck.jpg" alt="Image" class="img-fluid">
        ...
        <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
          <div class="team-member">
            ...
            <img src="images/dani.jpg" alt="Image" class="img-fluid">
        ...
        <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
          <div class="team-member">
            ...
            <img src="images/dagoc.jpg" alt="Image" class="img-fluid">
